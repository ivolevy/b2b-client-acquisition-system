...
const LandingPage = () => {
  ...
  const modules = [
    ...
    },
    {
      ...
      lead: (
        <>
          <p style={{ marginBottom: '16px' }}>Llegá a miles de leads calificados por el canal que prefieran.</p>
          <p style={{ margin: 0 }}>Infraestructura profesional para campañas de Email y WhatsApp Marketing de alto impacto.</p>
        </>
      ),
      visual: (
