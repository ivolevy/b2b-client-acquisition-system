...
try {
  ...
  // Leer líneas 7-9 como mencionó el usuario
  ...
  console.log('✅ Leyendo credenciales de .env.local');
} catch (e) {
  // Si no existe .env.local, continuar
  console.log('⚠️  No se encontró .env.local, usando variables de entorno o argumentos');
}
